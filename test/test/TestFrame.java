...
public class TestFrame extends JFrame{
    ...
    private class MyModel extends AbstractTableModel{
        ...
        public MyModel(){
            addTableModelListener(this.evento());
        }
        @Override
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            RowData rowData = rows.get(rowIndex);
            System.out.println("Cambiado a : "+aValue);
            rowData.setValueForCol(aValue,cols.get(columnIndex));
            fireTableCellUpdated(rowIndex, columnIndex);
        }
        
        private TableModelListener evento(){
            return new TableModelListener() {
                @Override
                public void tableChanged(TableModelEvent e) {
                    System.out.println("Tabla cambiada " + e.getColumn() + "  " + e.getLastRow());
